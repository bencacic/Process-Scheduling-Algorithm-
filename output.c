...
void makeGantChart(Process process[], int choice)
{
    ...
    printf(BOLD GRN);
    print_data( process, scale, choice);
    printf(RESET);
    printf("\n");
...
// Print average CPU burst time with dashes
    ...
    printf("Total burst time: %.0f units of time\n", burstTime);
    printf("--------------------------------------------------------\n");
    fprintf(filePtr, "Total burst time: %.2f units of time\n", burstTime);
    fprintf(filePtr,"--------------------------------------------------------\n");

    // Print turnaround time with dashes
    printf("Mean turnaround time: %.2f units of time per process\n", MeanTurnaroundTime);
    printf("--------------------------------------------------------\n");
    fprintf(filePtr, "Mean turnaround time: %.2f units of time per process\n", MeanTurnaroundTime);
    fprintf(filePtr,"--------------------------------------------------------\n");

    // Print mean waiting time with dashes
    printf("Mean wait time: %.2f units of time per process\n", meanWaitTime);
    printf("--------------------------------------------------------\n");
    fprintf(filePtr, "Mean wait time: %.2f units of time per process\n", meanWaitTime);
    fprintf(filePtr,"--------------------------------------------------------\n");


    //Print average response time with dashes
    printf("Mean response time: %.2f units of time per process\n", meanResponseTime);
    printf("--------------------------------------------------------\n");
    fprintf(filePtr, "Mean response time: %.2f units of time per process\n", meanResponseTime);
    fprintf(filePtr,"--------------------------------------------------------\n");

    // Print throughput with dashes
    printf("Mean throughput: %.6f processes per units of time\n", throughput);
    printf("--------------------------------------------------------\n");
    fprintf(filePtr, "Mean throughput: %.6f processes per units of time\n", throughput);
    fprintf(filePtr,"--------------------------------------------------------\n");
